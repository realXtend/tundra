/** @file MaxHeap.h
	...
	@brief Implements a max heap data structure, see http://en.wikipedia.org/wiki/Binary_heap.
...
#include "clb/Container/Array.h"
#include "clb/Algorithm/SortCmp.h"
...
template<typename T, typename PriorityCmp = clb::sort::TriCmpObj<T>,
         typename EqualCmp = clb::sort::TriCmpObj<T>, 
