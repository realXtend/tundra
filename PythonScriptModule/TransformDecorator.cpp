...
namespace PythonScript {
    ...
    void TransformDecorator::SetPos(Transform* self, Vector3df pos)
    {
        self->position = pos;
    }
    ...
    void TransformDecorator::SetRot(Transform* self, Vector3df rot)
    {
        self->rotation = rot;
    }
    ...
    void TransformDecorator::SetScale(Transform* self, Vector3df scale)
    {
        self->scale = scale;
    }
}
