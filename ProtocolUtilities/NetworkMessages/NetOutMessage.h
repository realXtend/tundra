...
#ifndef incl_ProtocolUtilities_NetOutMessage_h
#define incl_ProtocolUtilities_NetOutMessage_h
...
namespace ProtocolUtilities
{
    ...
    public:
        /// Default constructor.
        /// Resets NetOutMessage ready for adding data.
        NetOutMessage();
        ...
        void AddVector3(const RexTypes::Vector3 &value);
        void AddVector3d(const RexTypes::Vector3d &value);
        void AddVector4(const RexTypes::Vector4 &value);
