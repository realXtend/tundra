...
macro (INCLUDE_OPENJPEG)
  if (MSVC)
    include_directories (${ENV_NAALI_DEP_PATH}/OpenJpeg/include)
    link_directories (${ENV_NAALI_DEP_PATH}/OpenJpeg/lib)
    include_directories (${ENV_NAALI_DEP_PATH}/OpenJpeg/libopenjpeg/)
    link_directories (${ENV_NAALI_DEP_PATH}/OpenJpeg/Debug)
    link_directories (${ENV_NAALI_DEP_PATH}/OpenJpeg/Release)
