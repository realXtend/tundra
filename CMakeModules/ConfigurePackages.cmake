...
macro (configure_ogre)
    ...
    if (NOT WIN32)
        ...
        if (DirectX_FOUND)
            ...
            message (STATUS "-- Install DirextX SDK to enable additional features. If you already have the DirectX SDK installer")
            message (STATUS "   please set DIRECTX_ROOT evn variable as your install location.")
        endif()
        message (STATUS "")
    endif ()
