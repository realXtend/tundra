...
void  EC_3DGizmo::Show()
{
    ...
    if (!rulerObject)
    {
        LogError("EC_3DGizmo not initialized properly.");
        return;
    }
...
bool EC_3DGizmo::IsVisible() const
{
    if (rulerObject)
