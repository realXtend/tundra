...
namespace Naali
{
    ...
    public slots:
        ...
        //! handles resouce ready event and if tag fits, convert it into QImage format and set it to TextureImageLabel-label.
        void HandleResouceReady(Resource::Events::ResourceReady *res);

        //! Listenes when TextureLabel has been pressed.
