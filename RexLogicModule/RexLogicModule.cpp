...
void RexLogicModule::Initialize()
{
    ...
    // Listen for QKeyEvents generated by the UIView, and generate "Input" category events
    // INFO: to enable KeyStateListener uncomment
    //key_state_listener_ = new KeyStateListener (eventmgr);
    //key_state_listener_-> SetKeyBindings (third_person_bindings_.map);
    //framework_->AddUIViewListener(key_state_listener_);
...
{
    {
        ...
        // INFO: to enable KeyStateListener uncomment
        //bool world_has_focus = (!framework_->GetUIView()->scene()->focusItem());
        //key_state_listener_-> Update (world_has_focus);
    }
