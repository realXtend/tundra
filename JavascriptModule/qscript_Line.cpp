...
static QScriptValue Line_Contains_float3_float(QScriptContext *context, QScriptEngine *engine)
{
    if (context->argumentCount() != 2) { printf("Error! Invalid number of arguments passed to function Line_Contains_float3_float in file %s, line %d!\nExpected 2, but got %d!\n", __FILE__, __LINE__, context->argumentCount()); PrintCallStack(context->backtrace()); return QScriptValue(); }
    Line This = qscriptvalue_cast<Line>(context->thisObject());
...
QScriptValue register_Line_prototype(QScriptEngine *engine)
{
    ...
    proto.setProperty("GetPoint", engine->newFunction(Line_GetPoint_float, 1), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Transform", engine->newFunction(Line_Transform_selector, 1), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Contains", engine->newFunction(Line_Contains_float3_float, 2), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToRay", engine->newFunction(Line_ToRay, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToLineSegment", engine->newFunction(Line_ToLineSegment_float, 1), QScriptValue::Undeletable | QScriptValue::ReadOnly);
