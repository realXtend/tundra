...
namespace CoreUi
{
	...
	{
        setFlat(true);
        setStyleSheet(QString("QPushButton { min-width: 50px; padding-left: 5px; padding-right: 5px; font-size: 11px; color: rgb(61, 80, 255); background-color: rgba(255, 255, 255, 0); }")
                      .append("QPushButton::hover { color: rgb(85, 170, 255); } QPushButton::!hover { color: rgb(255, 255, 255); } QPushButton::pressed { color: rgba(85, 170, 255, 100); border: 0px; }"));
