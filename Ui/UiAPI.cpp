...
UiWidget *UiAPI::AddWidgetToWindow(QWidget* widget, Qt::WindowFlags flags, const QStringList &params)
{
    UiWidget *new_widget = new UiWidget(widget, mainWindow, flags, params);
