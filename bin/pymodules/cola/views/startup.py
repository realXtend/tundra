...
class StartupDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        print "Startup dialog Title set"
...
#        self._vlayt.addWidget(self._bookmark_list)
        ...
        print "Startup dialog Layout set"

        self._open_btn.connect('clicked()', self._open)
        self._clone_btn.connect('clicked()', self._clone)
        self._close_btn.connect('clicked()', self.reject)
        print "Startup dialog buttons connected"
        #self._bookmark_list.connect('activated(const QModelIndex &)', self._open_bookmark)
