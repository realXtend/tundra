...
from PythonQt.QtGui import QFont
from PythonQt.QtGui import QSyntaxHighlighter
from PythonQt.QtGui import QTextCharFormat
from PythonQt.QtGui import QColor
try:
    from PythonQt.QtCore import pyqtProperty
except ImportError:
    pyqtProperty = None
