...
try:
    ...
    print "***************** No python socket module, attempts to use socket classes will result in NameErrors"
    print "***************** Continuing anyway in case you're stuck on windows debug build with incomplete python build"
