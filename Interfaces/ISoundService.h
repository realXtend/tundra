...
public slots:
     ...
     */
    virtual ISoundService::SoundState GetSoundState(sound_id_t id) const = 0;
    ...
    /*! \param id Channel id
        \return Sound type
     */
    virtual ISoundService::SoundType GetSoundType(sound_id_t id) const = 0;
...
public:
    ...
    const ISoundService::SoundBuffer& GetBuffer() { return buffer_; }
