...
namespace TaigaProtocol
{
    ...
    void TaigaLoginThread::SetupXMLRPCLogin(const QString& worldAddress,
    ...
    bool TaigaLoginThread::PerformXMLRPCLogin()
    {
        ...
        try
        {
            ...
            call.AddMember("start", std::string("last"));
            // TODO: Get version from config manager
            call.AddMember("version", std::string("realXtend Naali 0.0.2"));
            call.AddMember("channel", std::string("realXtend"));
            // TODO: Get platform from OS
            call.AddMember("platform", std::string("Win"));
