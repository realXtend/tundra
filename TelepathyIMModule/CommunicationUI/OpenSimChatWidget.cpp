...
namespace CommunicationUI
{
          ...
          clientParams_(clientParams)
    {
        try
        {
            ...
            Communication::TelepathyIMModule::LogInfo("OpenSim WorldChat >> Startup successful");
        }
        catch (Exception e)
        {
            QString msg( QString("Initialisations threw an exteption: %1").arg(e.what()));
            Communication::TelepathyIMModule::LogInfo(msg.toStdString());
        }
    }
    ...
    void OpenSimChatWidget::OnOpensimUdpConnectionReady(Communication::ConnectionInterface& connection)
    {
        ...
        catch (Exception &e)
        {
            ...
            Communication::TelepathyIMModule::LogError(message.toStdString());
        }
    }
    ...
    void OpenSimChatWidget::OnOpensimUdpConnectionError(Communication::ConnectionInterface& connection)
    {
        ...
        Communication::TelepathyIMModule::LogDebug(message.toStdString());
    }
