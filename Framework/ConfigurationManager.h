...
public:
    ...
    */
    ...
    /** If given path is a file, file data will be loaded into runtime memory map, file encoding must match current name encoding see @p SetFileNameEncoding() 
    ...
    */
    ...
    /// Exports settings into xml data files. XML-files are created in given path.
    /** If @p group is other then empty string, only that group values are exported (into corresponding xml-file). See below how xml files are generated.
    ...
    */
    ...
    DeclareSetting(const std::string& group, const std::string& key, const T& defaultValue) const;
    ...
    */
    template <typename T>
    void SetSetting(const std::string& group, const std::string& key, const T& value);
    ...
    */
    template <typename T>
    T GetSetting(const std::string& group, const std::string& key) const;
