...
static QScriptValue Quat_Equals_Quat_float(QScriptContext *context, QScriptEngine *engine)
{
    if (context->argumentCount() != 2) { printf("Error! Invalid number of arguments passed to function Quat_Equals_Quat_float in file %s, line %d!\nExpected 2, but got %d!\n", __FILE__, __LINE__, context->argumentCount()); PrintCallStack(context->backtrace()); return QScriptValue(); }
    Quat This = qscriptvalue_cast<Quat>(context->thisObject());
    Quat rhs = qscriptvalue_cast<Quat>(context->argument(0));
...
static QScriptValue Quat_ToQQuaternion(QScriptContext *context, QScriptEngine *engine)
{
    if (context->argumentCount() != 0) { printf("Error! Invalid number of arguments passed to function Quat_ToQQuaternion in file %s, line %d!\nExpected 0, but got %d!\n", __FILE__, __LINE__, context->argumentCount()); PrintCallStack(context->backtrace()); return QScriptValue(); }
    Quat This = qscriptvalue_cast<Quat>(context->thisObject());
...
QScriptValue register_Quat_prototype(QScriptEngine *engine)
{
    ...
    proto.setProperty("WorldX", engine->newFunction(Quat_WorldX, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("WorldY", engine->newFunction(Quat_WorldY, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("WorldZ", engine->newFunction(Quat_WorldZ, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Axis", engine->newFunction(Quat_Axis, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Angle", engine->newFunction(Quat_Angle, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Dot", engine->newFunction(Quat_Dot_Quat, 1), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("LengthSq", engine->newFunction(Quat_LengthSq, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Length", engine->newFunction(Quat_Length, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Normalize", engine->newFunction(Quat_Normalize, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Normalized", engine->newFunction(Quat_Normalized, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("IsNormalized", engine->newFunction(Quat_IsNormalized_float, 1), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("IsInvertible", engine->newFunction(Quat_IsInvertible_float, 1), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("IsFinite", engine->newFunction(Quat_IsFinite, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Equals", engine->newFunction(Quat_Equals_Quat_float, 2), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Inverse", engine->newFunction(Quat_Inverse, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("Inverted", engine->newFunction(Quat_Inverted, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    ...
    proto.setProperty("ToEulerYZY", engine->newFunction(Quat_ToEulerYZY, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerZXZ", engine->newFunction(Quat_ToEulerZXZ, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerZYZ", engine->newFunction(Quat_ToEulerZYZ, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerXYZ", engine->newFunction(Quat_ToEulerXYZ, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerXZY", engine->newFunction(Quat_ToEulerXZY, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerYXZ", engine->newFunction(Quat_ToEulerYXZ, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerYZX", engine->newFunction(Quat_ToEulerYZX, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerZXY", engine->newFunction(Quat_ToEulerZXY, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToEulerZYX", engine->newFunction(Quat_ToEulerZYX, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToFloat3x3", engine->newFunction(Quat_ToFloat3x3, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToFloat3x4", engine->newFunction(Quat_ToFloat3x4, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
    proto.setProperty("ToFloat4x4", engine->newFunction(Quat_ToFloat4x4, 0), QScriptValue::Undeletable | QScriptValue::ReadOnly);
